...
![image-20250216164200905](反射机制/image-20250216164200905.png)
...
![image-20250217181846158](反射机制/image-20250217181846158.png)
...
![image-20250217190501444](反射机制/image-20250217190501444.png)

## 类的加载过程

当程序主动使用某个类时，如果该类还未被加载到内存中，系统会通过**加载、链接、初始化**三个步骤来对该类进行初始化。如果没有意外，JVM将会连续完成这三个步骤，所以有时也把这三个步骤统称为类加载。

![image-20250217190542070](反射机制/image-20250217190542070.png)
...
![image-20250217190711494](反射机制/image-20250217190711494.png)
...
![image-20250217190940375](反射机制/image-20250217190940375.png)
...
![image-20250217191156954](反射机制/image-20250217191156954.png)
